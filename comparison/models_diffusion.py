...
from .diffusion_core import timestep_embedding
...
class ResUNet(nn.Module):
    def __init__(self, in_ch=3, base_ch=48, time_dim=64, time_emb_dim=256, use_axial=True, ax_heads=2):
        super().__init__()
    ...
    def forward(self, x, t):
        ...
        h1 = self.enc1[0](x, emb); h1 = self.enc1[1](h1, emb)
